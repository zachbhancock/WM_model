...
run_name = "bioprj_PRJNA473221_Bombus-bifarius" #dataset name
functiondir = "/Users/rachel/WM_model/" #indir
outdir = "/Users/rachel/WM_model/empirical/data/bioprj_PRJNA473221_Bombus-bifarius/outputs_from_WM" #outdir
minPropIndivsScoredin = 0.5 #percent of indivs that locus must have been scored in to save
model_flavor = "wishart" #flavor of WM model to run
