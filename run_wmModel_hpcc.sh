...
WORKINGDIR=wm_expcon_output_10
...
cp $SLURM_SUBMIT_DIR/expcon_10/wmModel_*_sigma_"$SIGMA"_K_"$K"-pi.csv $WORKINGDIR
cp $SLURM_SUBMIT_DIR/expcon_10/wmModel_*_sigma_"$SIGMA"_K_"$K"-pi_locs.txt $WORKINGDIR
