...
cp $SLURM_SUBMIT_DIR/expcon_output_1/wmModel_*_sigma_"$SIGMA"_K_"$K"-pi.csv $WORKINGDIR
cp $SLURM_SUBMIT_DIR/expcon_output_1/wmModel_*_sigma_"$SIGMA"_K_"$K"-pi_locs.txt $WORKINGDIR
