...
cp $SLURM_SUBMIT_DIR/exp_10_out/wmModel_*_sigma_"$SIGMA"_K_"$K"-pi.csv $WORKINGDIR
cp $SLURM_SUBMIT_DIR/exp_10_out/wmModel_*_sigma_"$SIGMA"_K_"$K"-pi_locs.txt $WORKINGDIR
